...
div { background-color: hsl(220, 20%, 97%); }
div { background-color: transparent; }   /* default — shows parent through */
```
...
.card {
  background-image:
    linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)),  /* dark overlay on top */
    url('/images/photo.jpg');                                    /* image underneath */
  background-size: cover;
  color: white;
}
...
.hero {
  background-image:
    ...
    linear-gradient(135deg, royalblue, crimson);
