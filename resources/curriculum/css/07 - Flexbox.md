...
```css
.item   { flex-grow: 0; }  /* default — do not grow */
.item   { flex-grow: 1; }  /* grow equally with other flex-grow: 1 items */
.wide   { flex-grow: 2; }  /* takes twice as much extra space */
```
...
.fixed   { flex-shrink: 0; }  /* do not shrink */
```
...
```css
.item { flex-basis: auto; }   /* default — use the item's content width */
.item { flex-basis: 200px; }
.item { flex-basis: 30%; }
.item { flex-basis: 0; }      /* all extra space is distributed by flex-grow */
```
...
.item { flex: 1; }         /* shorthand for flex: 1 1 0 — grow and shrink equally */
...
.column    { flex: 1; }  /* each column takes equal share */
```
