...
h1 {
  font-size: clamp(1.5rem, 4vw, 3rem);  /* scales with viewport, but has min/max */
}
```
...
.half      { width: 50%; }       /* 50% of parent's width */
p          { line-height: 150%; } /* 150% of the element's font-size */
```
